...
public final class DaggerCalorieAIApplication_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends CalorieAIApplication_HiltComponents.ViewModelC {
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.resultViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 3);
    ...
    public Map<String, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(6).put("com.calorieai.app.ui.screens.add.AddFoodViewModel", ((Provider) addFoodViewModelProvider)).put("com.calorieai.app.ui.screens.camera.CameraViewModel", ((Provider) cameraViewModelProvider)).put("com.calorieai.app.ui.screens.home.HomeViewModel", ((Provider) homeViewModelProvider)).put("com.calorieai.app.ui.screens.result.ResultViewModel", ((Provider) resultViewModelProvider)).put("com.calorieai.app.ui.screens.settings.SettingsViewModel", ((Provider) settingsViewModelProvider)).put("com.calorieai.app.ui.screens.stats.StatsViewModel", ((Provider) statsViewModelProvider)).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.calorieai.app.ui.screens.add.AddFoodViewModel 
          return (T) new AddFoodViewModel(singletonCImpl.foodRecordRepositoryProvider.get());

          case 1: // com.calorieai.app.ui.screens.camera.CameraViewModel 
          return (T) new CameraViewModel();

          case 2: // com.calorieai.app.ui.screens.home.HomeViewModel 
          return (T) new HomeViewModel(singletonCImpl.foodRecordRepositoryProvider.get());

          case 3: // com.calorieai.app.ui.screens.result.ResultViewModel 
          return (T) new ResultViewModel(singletonCImpl.foodRecordRepositoryProvider.get());

          case 4: // com.calorieai.app.ui.screens.settings.SettingsViewModel 
          return (T) new SettingsViewModel(singletonCImpl.backupManagerProvider.get());

          case 5: // com.calorieai.app.ui.screens.stats.StatsViewModel 
          return (T) new StatsViewModel(singletonCImpl.foodRecordRepositoryProvider.get());
  ...
  private static final class SingletonCImpl extends CalorieAIApplication_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.foodRecordRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<FoodRecordRepository>(singletonCImpl, 0));
      this.backupManagerProvider = DoubleCheck.provider(new SwitchingProvider<BackupManager>(singletonCImpl, 2));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.calorieai.app.data.repository.FoodRecordRepository 
          ...
          case 2: // com.calorieai.app.service.backup.BackupManager 
          return (T) new BackupManager(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.foodRecordDao());
